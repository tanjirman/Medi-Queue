...
export default function AddTutorPage() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      // 1. Get the Token from your Auth Client
      ...
      // 2. Map form data to the shape your MongoDB collection expects
      const tutorData = {
        name: data.name,
        photo: data.image,
        ...
        sessionStartDate: data.sessionDate,
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/tutors`, {
        ...
        headers: {
          ...
          "Authorization": `Bearer ${tokenData.token}` // Corrected variable usage
        },
