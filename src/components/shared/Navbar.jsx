...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-0 left-0 w-full z-50 flex justify-center">
      <nav className="w-full max-w-8xl my-6 mx-4 flex items-center justify-between px-6 py-3 bg-white/80 dark:bg-slate-950/80 backdrop-blur-md rounded-2xl shadow-lg border border-slate-100 dark:border-white/10">
