          ...
          <Modal.Dialog className="sm:max-w-2xl rounded-[32px] bg-white dark:bg-slate-900 border border-black/5 shadow-2xl overflow-hidden">
            ...
            <Modal.Header>
              ...
              <p className="mt-1.5 text-xs text-default-400">
                Modifying details for tracking entry:{" "}
            ...
            <Modal.Body className="p-0 max-h-[65vh] overflow-y-auto">
              ...
              <form
                id="update-tutor-form"
                onSubmit={handleSubmit}
                className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4 text-left"
              >
                <TextField
                  className="w-full"
                  name="name"
...
sessionStartDate}
            ...
            <Modal.Footer>
              ...
              <Button
                form="update-tutor-form"
                type="submit"
                isLoading={updating}
                className="bg-linear-to-r from-cyan-500 to-blue-600 text-white font-semibold"
              >
