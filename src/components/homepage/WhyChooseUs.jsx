  ...
  return (
    <section className="py-24 bg-linear-to-b from-white to-cyan-50 dark:from-black dark:to-slate-950">
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        ...
        {/* BOTTOM STATS */}
        <div ref={ref} className="mt-24 grid grid-cols-2 md:grid-cols-4 gap-6">
          {/* CARD 1 */}
          <div className="rounded-3xl bg-white dark:bg-white/5 border border-black/5 dark:border-white/10 p-8 text-center shadow-lg hover:-translate-y-2 transition-all duration-300">
            ...
            <p className="mt-2 text-default-600">Active Tutors</p>
          </div>
          ...
          <div className="rounded-3xl bg-white dark:bg-white/5 border border-black/5 dark:border-white/10 p-8 text-center shadow-lg hover:-translate-y-2 transition-all duration-300">
            ...
            <p className="mt-2 text-default-600">Sessions Booked</p>
          </div>
          ...
          <div className="rounded-3xl bg-white dark:bg-white/5 border border-black/5 dark:border-white/10 p-8 text-center shadow-lg hover:-translate-y-2 transition-all duration-300">
            ...
            <p className="mt-2 text-default-600">Satisfaction Rate</p>
          </div>
          ...
          <div className="rounded-3xl bg-white dark:bg-white/5 border border-black/5 dark:border-white/10 p-8 text-center shadow-lg hover:-translate-y-2 transition-all duration-300">
            ...
            <p className="mt-2 text-default-600">Learning Access</p>
          </div>
        </div>
      </div>
    </section>
